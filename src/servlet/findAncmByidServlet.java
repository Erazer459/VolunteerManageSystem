...
@WebServlet("/findAncmByidServlet")
public class findAncmByidServlet extends HttpServlet {
    @Override
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
       ...
       req.getRequestDispatcher("student/jsp/stuChenkAncm.jsp").forward(req,resp);
    }
}
